...
from hometap_interview.app import create_app
from hometap_interview.config import TestConfig
...
@pytest.fixture()
def house_canary_response():
    """
    Normally wouldn't put this huge json blob here like this, but for the sake of time and not adding complexity
    I'm going with it.
    """
    return {
        "property/details": {
